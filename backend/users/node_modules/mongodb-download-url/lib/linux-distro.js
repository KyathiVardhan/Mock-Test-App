...
const debug = (0, debug_1.default)('mongodb-download-url:linux-distro');
...
async function getCurrentLinuxDistro() {
    ...
    if (osRelease) {
        ...
        const codename = (_c = osRelease.match(/^VERSION_CODENAME="?(.+?)"?$/m)) === null || _c === void 0 ? void 0 : _c[1];
...
function listDistroIds({ id, version, codename, }) {
    const results = [];
    switch (id.toLowerCase()) {
        case 'ubuntu': {
            ...
            if (major >= 24)
                results.push({ value: 'ubuntu2404', priority: 700 });
            if (major > 24)
                results.push({
