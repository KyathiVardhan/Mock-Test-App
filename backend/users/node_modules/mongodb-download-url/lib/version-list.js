...
const debug = (0, debug_1.default)('mongodb-download-url:version-list');
...
async function getFullJSON(opts) {
    ...
    if (!fullJSON || !inMemoryCopyUpToDate()) {
        ...
        const response = await (0, node_fetch_1.default)(versionListUrl);
        if (!response.ok) {
        ...
        if (tryWriteCache) {
            ...
            try {
                ...
                await fs_1.promises.writeFile(partialFilePath, compressed, {
                    mode: 0o644,
                    flag: 'wx',
                });
